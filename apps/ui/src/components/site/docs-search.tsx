      ...
      {open && (
        <div className="fixed inset-0 z-[100] flex items-start justify-center px-4 pt-[10vh] sm:pt-[14vh]">
          <button
            ...
            className="absolute inset-0 h-full w-full cursor-default rounded-none border-0 bg-black/50 p-0"
            onClick={close}
          />
          <div
            role="dialog"
            aria-modal="true"
            aria-label="Search documentation"
            className="relative w-full max-w-[34rem] overflow-hidden rounded-lg border border-border-strong bg-bg shadow-[0_24px_80px_rgba(0,0,0,0.28)]"
          >
