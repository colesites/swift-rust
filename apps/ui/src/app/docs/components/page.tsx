  ...
  return (
    ...
    >
      ...
      {c.status === "soon" ? (
        ...
        <span className="size-1.5 shrink-0 rounded-full bg-accent" aria-label="featured" />
      ) : (
        <span
          aria-hidden
    ...
    <article className="mx-auto w-full max-w-5xl">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <h1 className="mt-2 font-display text-4xl font-semibold tracking-tight">Components</h1>
      ...
      <div className="mt-10 grid grid-cols-1 gap-x-8 gap-y-px border-t border-border pt-2 sm:grid-cols-2 lg:grid-cols-3">
        {COMPONENTS.map((c) => (
