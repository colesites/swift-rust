        ...
        <div className="container-page pt-20 pb-24 sm:pt-28 sm:pb-32">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-7 max-w-xl text-pretty text-lg leading-relaxed text-fg-muted">
              TSX, streaming SSR, file-system routing, and a single binary at
              deploy.{" "}
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
              <Link href={siteConfig.docsUrl} className="btn btn-accent btn-lg">
                Get started
                <svg
                  viewBox="0 0 24 24"
                  className="h-4 w-4"
        ...
        <div className="container-page">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-pretty text-fg-muted">
              Pick a mode when you scaffold. Change it later in one line of
              config.
            </p>
          </div>
            ...
            {RENDERERS.map((r) => (
              <div key={r.name} className="flex flex-col gap-2 bg-surface p-6">
                <div className="flex items-center justify-between">
                  ...
                  {r.badge ? (
                    <span className="badge badge-accent">{r.badge}</span>
                  ) : null}
                </div>
          ...
          <div className="grid items-start gap-16 lg:grid-cols-[1fr_1.4fr]">
            <div className="lg:sticky lg:top-24">
              ...
              <p className="mt-4 text-fg-muted">
                Field notes, release announcements, and the occasional rant
                about bundlers.
              </p>
              <Link
                href="/blog"
        ...
        <div className="container-page">
          <div className="rounded-3xl border border-border bg-fg p-12 text-center sm:p-16">
            ...
            <p className="mx-auto mt-4 max-w-lg text-pretty text-fg-subtle">
              Install with one command. Scaffold a project, write TSX, ship a
              binary.
            </p>
    ...
    <div className="mx-auto mt-20 max-w-4xl overflow-hidden rounded-2xl border border-border bg-surface shadow-[0_24px_64px_-12px_rgb(0_0_0_0.12)]">
      ...
      <pre className="overflow-x-auto p-6 font-mono text-[0.8125rem] leading-relaxed">
        <code>
          ...
          <span className="text-fg-muted">=</span>
          <span className="text-success">"container"</span>
          <span className="text-fg-muted">{">"}</span>
          {"\n      <"}
...
function IconLayers({ className = "" }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M12 3 2 8l10 5 10-5-10-5ZM2 14l10 5 10-5M2 18l10 5 10-5"
        strokeLinejoin="round"
      />
    </svg>
  );
